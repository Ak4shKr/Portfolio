...
import Logo from "../assets/web5.png";
...
const Navbar = () => {
  ...
  return (
    <div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-white">
      <div className=" ml-3 pt-2 cursor-pointer hover:scale-90 font-semibold text-[#ccd6f6] text-4xl">
        {/* <h3>&lt; akash /&gt;</h3> */}
      ...
      <div
        onClick={handleClick}
        className="md:hidden z-10 cursor-pointer hover:scale-150"
      >
        {!nav ? <FaBars /> : <FaTimes />}
      </div>
      ...
      <div className="hidden lg:flex fixed flex-col top-[35%] left-0">
        <ul>
          {/*linkedin */}
          <li className="w-[140px] h-[60px] flex justify-between items-center ml-[-80px] hover:ml-[-10px] duration-300 bg-blue-700">
            <a
              className="flex justify-between pr-[-15px] items-center w-full text-gray-300"
